...
/// </summary>
public class GhostChaseDiscoveryPlayer : EnemyStateBase
{
    protected  EnemyState _enemyState { get; set; }
    private Transform _thisTransform = null;

    public GhostChaseDiscoveryPlayer(IEnemyMove enemyMove)
    {
    ...
    {
        //プレイヤーを追いかける処理に移行
        //_enemyMove.EnemyAnimation.SetBool(EnemyState.Move, false);
